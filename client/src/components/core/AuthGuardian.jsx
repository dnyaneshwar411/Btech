    ...
    return (
      <div className="flex h-screen bg-white dark:bg-base-background transition-colors duration-200">
        ...
        <div className="flex-1 overflow-auto">
          <header className="bg-white dark:bg-base-secondary shadow-sm h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-base-border">
